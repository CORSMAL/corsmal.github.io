...
| **target_location_x_mm** | float | mm | real | Target X of container base centre before starting handover | No workspace bound enforced |
| **target_location_y_mm** | float | mm | real | Target Y of container base centre before starting handover | No workspace bound enforced |
| **target_location_z_mm** | float | mm | real | Target Z of container base centre before starting handover | No workspace bound enforced |
